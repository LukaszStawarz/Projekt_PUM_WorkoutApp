...
import com.example.workoutapp.databinding.ActivityLowerBodyBinding
import org.w3c.dom.Text

class LowerBodyActivity : AppCompatActivity() {
    private var binding : ActivityLowerBodyBinding? = null
    ...
    private var lowerExerciseList: ArrayList<Exercise>?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        lowerExerciseList = Constants.lowerExerciseList()
    ...
    private fun setupBreakView(){
        ...
        binding?.tvUpCommingExerciseName?.text = lowerExerciseList!![currentExercisePosition+1].getName()
    ...
    private fun setupExerciseView(){
        ...
        binding?.ivImage?.setImageResource(lowerExerciseList!![currentExercisePosition].getImage())
        binding?.tvExerciseName?.text = lowerExerciseList!![currentExercisePosition].getName()
        binding?.tvReps?.text = lowerExerciseList!![currentExercisePosition].getReps()
    ...
    private fun setExerciseTimer(){
        exerciseTimer = object : CountDownTimer(3000, 1000){
            ...
            override fun onFinish() {
                if(currentExercisePosition <lowerExerciseList?.size!! - 1){
                    setupBreakView()
                }else{
                    finish()
                    val intent = Intent(this@LowerBodyActivity,FinishActivity::class.java)
